  ...
  return (
    ...
    >
      <p style={{ margin: 0, color: '#d4d4d8', fontSize: '0.85rem', lineHeight: '1.5', flex: '1 1 300px' }}>
        To keep Olin's Prompt List up and running and to pay creators, we use third-party advertisements marked with an "Ad" label that are not affiliated directly with our platform.
      </p>
      <button 
