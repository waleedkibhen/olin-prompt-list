...
export default function PromptCard({ post, onLike, onSave }: PromptCardProps) {
  ...
  const requireAuth = (actionName: string): boolean => {
    if (!user) {
      alert(`Sign in to save this prompt!`);
      signInWithGoogle();
      return false;
    }
    return true;
  ...
  return (
    <>
      ...
      <article className={styles.cardContainer} onClick={() => setIsModalOpen(true)}>
        ...
        {/* Clean minimal caption beneath artwork */}
              ...
              <div className={styles.modalHeader}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                  ...
                  <a 
                    ...
                    style={{ padding: '0.4rem 0.65rem', fontSize: '0.78rem', display: 'flex', alignItems: 'center', gap: '0.3rem', borderRadius: '9999px' }}
                  >
